...
public class WeatherContract {
    ...
    //set data baru
    public static final String CONTENT_AUTHORITY = "com.example.jsusilo.udacityfixcuk";

    //use content provider
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    //set path for location and weather
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        //set table name for location setting
        public static final String COLUMN_LOCATION_SETTING = "location_setting";

        //set table name for column city name convert from id unik API to name city
        public static final String COLUMN_CITY_NAME = "city_name";

        //set table for longitute dan latitude
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        //set method static for location weather
        ...
        public static Uri buildWeatherLocationWithStartDate(String locationSetting, long startDate) {
            ...
            return CONTENT_URI.buildUpon().appendEncodedPath(locationSetting)
                    .appendQueryParameter(COLUMN_DATE, Long.toString(normalizeDate)).build();
        }
